...
filepath_X = os.path.join(os.path.dirname(__file__),'X.csv')
filepath_weather = os.path.join(os.path.dirname(__file__),'ExternalWeather.csv')
filepath_TRHE = os.path.join(os.path.dirname(__file__),'TRHE2018_subset.csv')
filepath_datapoint = os.path.join(os.path.dirname(__file__),'DataPoint.csv')
