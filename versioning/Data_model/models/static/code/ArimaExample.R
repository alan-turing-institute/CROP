...
cleanedDataPath = "./t_ee_August052021.RDS"
...
###
tobj_name = "Temperature_FARM_16B1"
...
plot(available.Data$FarmTime,available.Data$Sensor_temp, type = "l", col = "black", 
     xlim = c(as.POSIXct('2021-07-01 00:00:00', format = "%Y-%m-%d %H:%M:%S"), 
              as.POSIXct('2021-08-08 23:00:00', format = "%Y-%m-%d %H:%M:%S")),
     xlab = "Date",
...
# Output to csv
xf = c(tobj_name,"_","September2021_",daysOfHistoryForTraining,"_","fitted",".csv")
...
xf = c(tobj_name,"_","September2021_",daysOfHistoryForTraining,"_","forecast",".csv")
filename = paste(xf, collapse="")
