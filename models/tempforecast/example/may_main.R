...
source(paste0(daughter_folder,"/may_functions.R"), echo=FALSE)
...
for(mm in 1:length(sensor_loc)){
  ...
  Stat_energy = list_forecasts[[mm]][[2]]$mean,
  Stat_lights = list_forecasts[[mm]][[3]]$mean)
...
# print warning message based on stats_save
  ...
  ggsave("Forecast_",sensor_name,"_",as.Date(testtm),".png")
